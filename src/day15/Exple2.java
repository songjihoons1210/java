...
interface Buy{
    public abstract void buy(); // - 추상 메소드
    // + 디폴트 메소드 : 인터페이스타입에서 구현한 메소드 사용가능.
    public default  void method1() { }
    // * 정적 메소드  : 인터페이스타입에서 정적 구현 메소드 사용가능.
    public static void method2() { }
    // + private 메소드    : 현재 인터페이스타입 에서남 사용 가능한 구현 메소드
    private void method3() { }
    // + private static 메소드 : 현재 인터페이스타입 에서만 사용 가능한 정적 구현 메소드
    private static void method4() { }
}
interface Sell{ void sell(); }
class Costomer  extends  Object implements Buy,Sell{
...
public class Exple2 {
    public static void main(String[] args) {
        ...
        // [5] private 메소드 ?? 구현체에서 구현하지 않으면
        // 즉] 오버라이딩(재정의/구현) 금지

        // [6] private 정적 메소드
        // 타입 내부적으로 사용되는 정적 메소드.
        /*
    } // m e
} // c e
