    ...
    public static void main(String[] args) {
        /*
            [ 예외 처리 ]
                ...
                5. 예외 클래스
                    - ClassNotFoundException : 클래스를 못찾았을떄 발생되는 정보를 저장하는 클래스
                    - InterruptedException   : 흐름을 중단 되었을떄 발생되는 정보를 저장하는 클래스
                    - NullPointerException   :  객체가 없는데 객체가 접근연산자 사용 하면 발생 클래스
                ...
                6. 사용법
                    ...
                    catch( 예외클래스명 매개뱐수명 ) { 지정한예외발생시 처리할 코드 }
                    catch( 예외클래스명 매개뱐수명 ) { 지정한예외발생시 처리할 코드 }
                    catch( 예외클래스명 매개뱐수명 ) { 지정한예외발생시 처리할 코드 }
        ...
        // - 주의할점1 : 다중 catch 시 예외는 1번 발생하면 1개의 catch만 실행된다.
