...
show databases;		# [grid result] 창에서 화긴
...
create database tset0714;			# 'test0714' 이름의 데이터베이스를 생성한다.
show databases;						# DB서버내 모든 데이터베이스 목록 보기
use test0714;						# 지금부터 test0714; 데이터베이스 활성화
