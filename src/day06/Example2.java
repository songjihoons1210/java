...
public class Example2 { // c start
    public static void main(String[] args) { // m start
        ...
        // [2] 학생 클래스 이용한 학생 객체 만들기 : 자바는 객체를 만들기 위해서 *무조건*클래가 필요하다.
            // 2. 객체 만들기                   : new 클래스명();
        new Student(); // 객체 생성
        // [3] 주로 생성된 객체는 변수에 대입/저장 한다. 타입 변수명 = 값 ; ,  타임 변수명 = 객체;
            // * 객체를 저장하는 변수의 타입은 객체의 클래스/타입 로 선언한다.
        Student s1 = new Student();
        // [4] 생성된 객체 정보 호출
        System.out.println(s1); // day06.Student@119d7947 : 객체의 주소(컴퓨터내 메모리 위치) 값이 반환 된다.
        // [5] 객체내 멤버변수 호출
        ...
        // [8] 붕어빵 객체 만들기
            ...
            // 3) 객체와 배열이 관계 : 배열은 동일한 타입/클래스 데이터/객체를 여러개 저장
...
class Student{ // 클래스란? 객체를 만들귀 위해 객체내 필요한 속성 고 ㅏ기능을 설계/정의
    int studentID;
