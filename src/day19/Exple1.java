...
class BoardDto{
    ...
    public String toString() {
        return "인스턴스 주소{메모리위치} 대신에 넣을 문자";
    }
}
    ...
    public static void main(String[] args) {
      /*
        ...
        [ 자바의 기본 클래스 ]
            ...
            2. Class 클래스 : 클래스의 정보를 닫는 클래스
                특징 : *리플랙션*(실행중 객체 할당 , 분석 )
                주요메소드
            ...
            3. Wrapper 클래스 : 8가지 기본타입을 참조타입 사용
                ...
                종류 : Byte Short Integer long,
                 ...
                 주요메소드 :
                    1) .parseXXXX("문자열") : 문자열 ---> XXXX 타입 반환 메소드
        ...
        */
        ...
        // 지정한 클래스경에서 클래스를 로드/불러오기 메소드 * 일반예외
        // -> 지정한 클래스경로에서 클래ㅡ를 로드 실패시 예외 발생
        try{ Class.forName("java.lang.String"); }
        catch (ClassNotFoundException e) { }

        // 2. .getFields() : 클래스/타입 의 모든 멤버변수명 반환
        ...
        System.out.println(localTime); // 11:38:12.690832300
        LocalDateTime localDateTime = LocalDateTime.now();
        System.out.println(localDateTime); // 2025-07-25T11:38:12.690832300
        ...
        // 3. 날짜/시간 형식 변경
            // 패턴 : y연도 , m월 , d일 , h시 , m분 s초
            // 날짜/시간객체.format( 형식객체) : 지정한 형식으로 변환된 문자열 ㅏㅂㄴ환
        DateTimeFormatter formatter
                = DateTimeFormatter.ofPattern("yyyy-MM월-dd일 HH:mm:ss");
        String today = localDateTime.format( formatter );;
        System.out.println( today ); // 2025-07월-25일 11:44:04
        ...
        int seconds =  localDateTime.getSecond(); // 초

        // 5. 날짜 계산
        LocalDateTime plusDateTime = localDateTime.plusDays( 30 );
        System.out.println(plusDateTime); // 2025-08-24T11:51:04.676420400
        LocalDateTime minusDateTime = localDateTime.minusDays( 30 );
        System.out.println(minusDateTime); // 2025-06-25T11:51:04.676420400
