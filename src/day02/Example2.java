...
/*
        ...
        //      (1)  .next() : 키보드로부터 입력받은 문자열 반환 , 단] 띄어쓰기 불가능.
                ...
                (2) .nextLing() : 입력받은 문자열(String) 반환 , 단] 띄어쓰기 가능.
...
*/
        ...
        String a = scan.next();    // == new Scanner( System.in ).next();
        System.out.println("1. next result : " + a );

        // 2. nextLine();
        System.out.printf("2. nextLine() : ");
        scan.nextLine(); // 무의미한 next() , nextLine() 문제점 해결
        String b = scan.nextLine();
        System.out.println("2. nextLine() result : " + b );
        ...
        // 6. nextLong();   : 입력받은 정수(log)반환 , 입력받은 long 허용범위 벗어나면 오류
